...
short g_sSpriteIndexWallPuff1;
short g_sSpriteIndexWallPuff2;
...
void DecalGunshot( TraceResult *pTrace, int iBulletType )
{
	...
	if ( VARS(pTrace->pHit)->solid == SOLID_BSP || VARS(pTrace->pHit)->movetype == MOVETYPE_PUSHSTEP )
	{
		...
		case BULLET_PLAYER_MACHETE:
			// wall decal
			UTIL_DecalTrace( pTrace, DamageDecal( pEntity, DMG_SLASH ) );
			break;
		case BULLET_PLAYER_PISTOLWHIP:
			// wall decal
...
void W_Precache(void)
{
	...
	UTIL_PrecacheOther( "item_flakjacket" );
...
//	UTIL_PrecacheOtherWeapon( "weapon_shotgun" );
	...
	UTIL_PrecacheOther( "ammo_buckshot_large" );
...
//	UTIL_PrecacheOther( "ammo_9mmAR" );
	...
	UTIL_PrecacheOther( "ammo_m16box" );

	// m21
	UTIL_PrecacheOtherWeapon( "weapon_m21" );
	...
	UTIL_PrecacheOther( "ammo_762mmbox" );

	// m79
	UTIL_PrecacheOtherWeapon( "weapon_m79" );

	// 870
	UTIL_PrecacheOtherWeapon( "weapon_870" );
	UTIL_PrecacheOther( "ammo_elephantshot" );
	UTIL_PrecacheOther( "ammo_elephantshot_large" );

	// Colt 1911A1
	UTIL_PrecacheOtherWeapon( "weapon_colt1911a1" );
	UTIL_PrecacheOther( "ammo_1143mm" );
	UTIL_PrecacheOther( "ammo_1143mm_40box" );
	UTIL_PrecacheOther( "ammo_1143mm_50box" );

	// RPG7
	UTIL_PrecacheOtherWeapon( "weapon_rpg7" );
...
//	UTIL_PrecacheOtherWeapon( "weapon_hornetgun" );
	...
	g_sSpriteIndexWallPuff1 = PRECACHE_MODEL( "sprites/fast_wallpuff1.spr" );
	g_sSpriteIndexWallPuff2 = PRECACHE_MODEL( "sprites/fast_wallpuff2.spr" );
	...
	PRECACHE_SOUND ("weapons/gren_explode1.wav");//grenade
	PRECACHE_SOUND ("weapons/gren_explode2.wav");//grenade
	PRECACHE_SOUND ("weapons/gren_explode3.wav");//grenade
