...
// sounds used from C physics code
	...
	PRECACHE_SOUND ("weapons/tracer1.wav");
	PRECACHE_SOUND ("weapons/tracer2.wav");
	PRECACHE_SOUND ("weapons/tracer3.wav");
	PRECACHE_SOUND ("weapons/tracer4.wav");
	PRECACHE_SOUND ("weapons/tracer5.wav");
	PRECACHE_SOUND ("weapons/tracer6.wav");
	PRECACHE_SOUND ("weapons/tracer7.wav");
	PRECACHE_SOUND ("weapons/tracer8.wav");
	PRECACHE_SOUND ("weapons/tracer9.wav");
	PRECACHE_SOUND ("weapons/tracer10.wav");
//
