...
void CBasePlayer :: PlayStepSound(int step, float fvol)
{
	...
	case STEP_MUD:
		...
		{
		// right foot
		case 0:	EMIT_SOUND( ENT(pev), CHAN_BODY, "player/pl_mud1.wav", fvol, ATTN_NORM);	break;
		case 1:	EMIT_SOUND( ENT(pev), CHAN_BODY, "player/pl_mud3.wav", fvol, ATTN_NORM);	break;
		// left foot
		case 2:	EMIT_SOUND( ENT(pev), CHAN_BODY, "player/pl_mud2.wav", fvol, ATTN_NORM);	break;
		case 3:	EMIT_SOUND( ENT(pev), CHAN_BODY, "player/pl_mud4.wav", fvol, ATTN_NORM);	break;
		}
		break;
	}
}	
...
switch (chTextureType)
	...
	case CHAR_TEX_MUD: return STEP_MUD;
	}
}
...
// fallpain sound, and damage will be inflicted based on how far the player fell
	...
	{		
		...
		{
			CSoundEnt::InsertSound ( bits_SOUND_PLAYER, Classify(), pev->origin, m_flFallVelocity, 0.2 );
