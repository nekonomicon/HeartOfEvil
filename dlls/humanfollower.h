...
class CHumanFollower : public CHuman
{
public:
	virtual void Spawn( void );
	virtual void Precache( void );
	virtual CHumanFollower *MyHumanFollowerPointer( void ) { return this; };
	virtual int	ObjectCaps( void ) { return CHuman :: ObjectCaps() | FCAP_IMPULSE_USE; }
