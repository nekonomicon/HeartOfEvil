...
#define CLASS_HUMAN_CHARLIE		14 // Charlie isn't allied to the American military or the aliens
#define CLASS_HELICOPTER		15 // So ground monsters don't try to attack helicopters they can't hit
#define CLASS_PLANT				16 
