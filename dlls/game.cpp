...
// Charlie
cvar_t    sk_charlie_health1 = {"sk_charlie_health1","0"};
cvar_t    sk_charlie_health2 = {"sk_charlie_health2","0"};
cvar_t    sk_charlie_health3 = {"sk_charlie_health3","0"};
...
// gorilla
cvar_t	sk_gorilla_health1 = {"sk_gorilla_health1","0"};
cvar_t	sk_gorilla_health2 = {"sk_gorilla_health2","0"};
cvar_t	sk_gorilla_health3 = {"sk_gorilla_health3","0"};

cvar_t	sk_gorilla_dmg_jump1	= {"sk_gorilla_dmg_jump1","0"};
cvar_t	sk_gorilla_dmg_jump2	= {"sk_gorilla_dmg_jump2","0"};
cvar_t	sk_gorilla_dmg_jump3	= {"sk_gorilla_dmg_jump3","0"};

cvar_t	sk_gorilla_dmg_punch1 = {"sk_gorilla_dmg_punch1","0"};
cvar_t	sk_gorilla_dmg_punch2 = {"sk_gorilla_dmg_punch2","0"};
cvar_t	sk_gorilla_dmg_punch3 = {"sk_gorilla_dmg_punch3","0"};
...
// Huey
cvar_t	sk_huey_health1	= {"sk_huey_health1","0"};
cvar_t	sk_huey_health2	= {"sk_huey_health2","0"};
cvar_t	sk_huey_health3	= {"sk_huey_health3","0"};
...
cvar_t	sk_controller_dmgspit1 = {"sk_controller_dmgspit1","0"};
cvar_t	sk_controller_dmgspit2 = {"sk_controller_dmgspit2","0"};
cvar_t	sk_controller_dmgspit3 = {"sk_controller_dmgspit3","0"};

cvar_t	sk_controller_dmgpunch1 = {"sk_controller_dmgpunch1","0"};
cvar_t	sk_controller_dmgpunch2 = {"sk_controller_dmgpunch2","0"};
cvar_t	sk_controller_dmgpunch3 = {"sk_controller_dmgpunch3","0"};

// Kophyaeger
cvar_t    sk_kophyaeger_health1 = {"sk_kophyaeger_health1","0"};
cvar_t    sk_kophyaeger_health2 = {"sk_kophyaeger_health2","0"};
cvar_t    sk_kophyaeger_health3 = {"sk_kophyaeger_health3","0"};

cvar_t	sk_kophyaeger_dmg_bite1 = {"sk_kophyaeger_dmg_bite1","0"};
cvar_t	sk_kophyaeger_dmg_bite2 = {"sk_kophyaeger_dmg_bite2","0"};
cvar_t	sk_kophyaeger_dmg_bite3 = {"sk_kophyaeger_dmg_bite3","0"};

// MikeForce
cvar_t    sk_mikeforce_health1 = {"sk_mikeforce_health1","0"};
cvar_t    sk_mikeforce_health2 = {"sk_mikeforce_health2","0"};
cvar_t    sk_mikeforce_health3 = {"sk_mikeforce_health3","0"};
...
// SOG
cvar_t    sk_SOG_health1 = {"sk_SOG_health1","0"};
cvar_t    sk_SOG_health2 = {"sk_SOG_health2","0"};
cvar_t    sk_SOG_health3 = {"sk_SOG_health3","0"};

// Super zombie
cvar_t    sk_superzombie_health1 = {"sk_superzombie_health1","0"};
cvar_t    sk_superzombie_health2 = {"sk_superzombie_health2","0"};
cvar_t    sk_superzombie_health3 = {"sk_superzombie_health3","0"};

cvar_t    sk_superzombie_dmg_kick1 = {"sk_superzombie_dmg_kick1","0"};
cvar_t    sk_superzombie_dmg_kick2 = {"sk_superzombie_dmg_kick2","0"};
cvar_t    sk_superzombie_dmg_kick3 = {"sk_superzombie_dmg_kick3","0"};

cvar_t    sk_superzombie_dmg_bite1 = {"sk_superzombie_dmg_bite1","0"};
cvar_t    sk_superzombie_dmg_bite2 = {"sk_superzombie_dmg_bite2","0"};
cvar_t    sk_superzombie_dmg_bite3 = {"sk_superzombie_dmg_bite3","0"};
...
// Machete slash
cvar_t	sk_plr_machete1 = {"sk_plr_machete1","0"};
cvar_t	sk_plr_machete2 = {"sk_plr_machete2","0"};
cvar_t	sk_plr_machete3 = {"sk_plr_machete3","0"};

// Pistol Whip
cvar_t	sk_plr_pistolwhip1 = {"sk_plr_pistolwhip1","0"};
cvar_t	sk_plr_pistolwhip2 = {"sk_plr_pistolwhip2","0"};
cvar_t	sk_plr_pistolwhip3 = {"sk_plr_pistolwhip3","0"};
...
// ak47 Round
cvar_t	sk_plr_762x39_bullet1 = {"sk_plr_762x39_bullet1","0"};
cvar_t	sk_plr_762x39_bullet2 = {"sk_plr_762x39_bullet2","0"};
cvar_t	sk_plr_762x39_bullet3 = {"sk_plr_762x39_bullet3","0"};
...
// M21 Round
cvar_t	sk_plr_m21_bullet1 = {"sk_plr_m21_bullet1","0"};
cvar_t	sk_plr_m21_bullet2 = {"sk_plr_m21_bullet2","0"};
cvar_t	sk_plr_m21_bullet3 = {"sk_plr_m21_bullet3","0"};

// 11.43mm Round
cvar_t	sk_plr_1143_bullet1 = {"sk_plr_1143_bullet1","0"};
cvar_t	sk_plr_1143_bullet2 = {"sk_plr_1143_bullet2","0"};
cvar_t	sk_plr_1143_bullet3 = {"sk_plr_1143_bullet3","0"};
...
cvar_t	sk_1143_bullet1 = {"sk_1143_bullet1","0"};
cvar_t	sk_1143_bullet2 = {"sk_1143_bullet2","0"};
cvar_t	sk_1143_bullet3 = {"sk_1143_bullet3","0"};

cvar_t	sk_ak47_bullet1 = {"sk_ak47_bullet1","0"};
cvar_t	sk_ak47_bullet2 = {"sk_ak47_bullet2","0"};
cvar_t	sk_ak47_bullet3 = {"sk_ak47_bullet3","0"};

cvar_t	sk_shot_pellet1 = {"sk_shot_pellet1","0"};
cvar_t	sk_shot_pellet2 = {"sk_shot_pellet2","0"};
cvar_t	sk_shot_pellet3 = {"sk_shot_pellet3","0"};
...
cvar_t	sk_flakjacket1	= { "sk_flakjacket1","0" };			
cvar_t	sk_flakjacket2	= { "sk_flakjacket2","0" };			
cvar_t	sk_flakjacket3	= { "sk_flakjacket3","0" };			
...
cvar_t	sk_medic_heal1	= { "sk_medic_heal1","0" };	
cvar_t	sk_medic_heal2	= { "sk_medic_heal2","0" };	
cvar_t	sk_medic_heal3	= { "sk_medic_heal3","0" };	
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	// SGC charlie - add to GameDLLInit() function
	CVAR_REGISTER ( &sk_charlie_health1 );// {"sk_charlie_health1","0"};
	CVAR_REGISTER ( &sk_charlie_health2 );// {"sk_charlie_health2","0"};
	CVAR_REGISTER ( &sk_charlie_health3 );// {"sk_charlie_health3","0"};
	...
	// gorilla
	CVAR_REGISTER ( &sk_gorilla_health1 );// {"sk_gorilla_health1","0"};
	CVAR_REGISTER ( &sk_gorilla_health2 );// {"sk_gorilla_health2","0"};
	CVAR_REGISTER ( &sk_gorilla_health3 );// {"sk_gorilla_health3","0"};

	CVAR_REGISTER ( &sk_gorilla_dmg_jump1 );// {"sk_gorilla_dmg_jump1","0"};
	CVAR_REGISTER ( &sk_gorilla_dmg_jump2 );// {"sk_gorilla_dmg_jump2","0"};
	CVAR_REGISTER ( &sk_gorilla_dmg_jump3 );// {"sk_gorilla_dmg_jump3","0"};

	CVAR_REGISTER ( &sk_gorilla_dmg_punch1 );// {"sk_gorilla_dmg_punch1","0"};
	CVAR_REGISTER ( &sk_gorilla_dmg_punch2 );// {"sk_gorilla_dmg_punch2","0"};
	CVAR_REGISTER ( &sk_gorilla_dmg_punch3 );// {"sk_gorilla_dmg_punch3","0"};
	...
	// Huey
	CVAR_REGISTER ( &sk_huey_health1 );// {"sk_huey_health1","0"};
	CVAR_REGISTER ( &sk_huey_health2 );// {"sk_huey_health2","0"};
	CVAR_REGISTER ( &sk_huey_health3 );// {"sk_huey_health3","0"};
	...
	CVAR_REGISTER ( &sk_controller_dmgspit1 );
	CVAR_REGISTER ( &sk_controller_dmgspit2 );
	CVAR_REGISTER ( &sk_controller_dmgspit3 );

	CVAR_REGISTER ( &sk_controller_dmgpunch1 );
	CVAR_REGISTER ( &sk_controller_dmgpunch2 );
	CVAR_REGISTER ( &sk_controller_dmgpunch3 );

	// kophyaeger
	CVAR_REGISTER ( &sk_kophyaeger_health1 );
	CVAR_REGISTER ( &sk_kophyaeger_health2 );
	CVAR_REGISTER ( &sk_kophyaeger_health3 );

	CVAR_REGISTER ( &sk_kophyaeger_dmg_bite1 );
	CVAR_REGISTER ( &sk_kophyaeger_dmg_bite2 );
	CVAR_REGISTER ( &sk_kophyaeger_dmg_bite3 );

	// MikeForce
	CVAR_REGISTER ( &sk_mikeforce_health1 );
	CVAR_REGISTER ( &sk_mikeforce_health2 );
	CVAR_REGISTER ( &sk_mikeforce_health3 );
	...
	// SOG
	CVAR_REGISTER ( &sk_SOG_health1 );
	CVAR_REGISTER ( &sk_SOG_health2 );
	CVAR_REGISTER ( &sk_SOG_health3 );

	// Super Zombie
	CVAR_REGISTER ( &sk_superzombie_health1 );// {"sk_superzombie_health1","0"};
	CVAR_REGISTER ( &sk_superzombie_health2 );// {"sk_superzombie_health2","0"};
	CVAR_REGISTER ( &sk_superzombie_health3 );// {"sk_superzombie_health3","0"};

	CVAR_REGISTER ( &sk_superzombie_dmg_bite1 );// {"sk_superzombie_dmg_bite1","0"};
	CVAR_REGISTER ( &sk_superzombie_dmg_bite2 );// {"sk_superzombie_dmg_bite2","0"};
	CVAR_REGISTER ( &sk_superzombie_dmg_bite3 );// {"sk_superzombie_dmg_bite3","0"};

	CVAR_REGISTER ( &sk_superzombie_dmg_kick1 );// {"sk_superzombie_dmg_kick1","0"};
	CVAR_REGISTER ( &sk_superzombie_dmg_kick2 );// {"sk_superzombie_dmg_kick2","0"};
	CVAR_REGISTER ( &sk_superzombie_dmg_kick3 );// {"sk_superzombie_dmg_kick3","0"};
...
//	CVAR_REGISTER ( &sk_plr_crowbar3 );// {"sk_plr_crowbar3","0"};
	...
	// Machete slash
	CVAR_REGISTER ( &sk_plr_machete1 );
	CVAR_REGISTER ( &sk_plr_machete2 );
	CVAR_REGISTER ( &sk_plr_machete3 );

	// Pistol Whip
	CVAR_REGISTER ( &sk_plr_pistolwhip1 );
	CVAR_REGISTER ( &sk_plr_pistolwhip2 );
	CVAR_REGISTER ( &sk_plr_pistolwhip3 );
...
//	CVAR_REGISTER ( &sk_plr_9mmAR_bullet3 );// {"sk_plr_9mmAR_bullet3","0"};
	...
	// ak47 Round
	CVAR_REGISTER ( &sk_plr_762x39_bullet1 );// {"sk_plr_ak47_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_762x39_bullet2 );// {"sk_plr_ak47_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_762x39_bullet3 );// {"sk_plr_ak47_bullet3","0"};
	...
	// M21 Round
	CVAR_REGISTER ( &sk_plr_m21_bullet1 );// {"sk_plr_m21_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_m21_bullet2 );// {"sk_plr_m21_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_m21_bullet3 );// {"sk_plr_m21_bullet3","0"};

	// 11.43mm Round
	CVAR_REGISTER ( &sk_plr_1143_bullet1 );// {"sk_plr_1143_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_1143_bullet2 );// {"sk_plr_1143_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_1143_bullet3 );// {"sk_plr_1143_bullet3","0"};
...
//	CVAR_REGISTER ( &sk_plr_egon_wide3 );// {"sk_plr_egon_wide3","0"};
	...
	CVAR_REGISTER ( &sk_m16_bullet1 );
	CVAR_REGISTER ( &sk_m16_bullet2 );
	CVAR_REGISTER ( &sk_m16_bullet3 );

	CVAR_REGISTER ( &sk_762_bullet1 );
	CVAR_REGISTER ( &sk_762_bullet2 );
	CVAR_REGISTER ( &sk_762_bullet3 );

	CVAR_REGISTER ( &sk_1143_bullet1 );
	CVAR_REGISTER ( &sk_1143_bullet2 );
	CVAR_REGISTER ( &sk_1143_bullet3 );

	CVAR_REGISTER ( &sk_ak47_bullet1 );
	CVAR_REGISTER ( &sk_ak47_bullet2 );
	CVAR_REGISTER ( &sk_ak47_bullet3 );

	CVAR_REGISTER ( &sk_shot_pellet1 );
	CVAR_REGISTER ( &sk_shot_pellet2 );
	CVAR_REGISTER ( &sk_shot_pellet3 );
	...
	CVAR_REGISTER ( &sk_flakjacket1 );
	CVAR_REGISTER ( &sk_flakjacket2 );
	CVAR_REGISTER ( &sk_flakjacket3 );
	...
	CVAR_REGISTER ( &sk_medic_heal1 );
	CVAR_REGISTER ( &sk_medic_heal2 );
	CVAR_REGISTER ( &sk_medic_heal3 );
