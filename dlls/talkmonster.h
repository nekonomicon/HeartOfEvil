...
#define TLK_CFRIENDS		2

#define TLK_COMMAND_COME_HERE			0
#define TLK_COMMAND_ATTACK				1
#define TLK_COMMAND_RETREAT				2
#define TLK_COMMAND_GET_DOWN			3
#define TLK_COMMAND_SURPRESSING_FIRE	4
#define TLK_COMMAND_OUTTA_MY_WAY		5
#define TLK_COMMAND_BEHIND_YOU			6
...
enum
{
	...
	SCHED_FOLLOW_CLOSE,
	SCHED_SEARCH_AND_DESTROY,
	SCHED_SURPRESSING_FIRE,
	SCHED_RETREAT,
	SCHED_TURN_ROUND,
...
public:
	...
	friend void TalkMonsterCommand( int iCommand );
	virtual void PlayerCommand( int iCommand );
};
