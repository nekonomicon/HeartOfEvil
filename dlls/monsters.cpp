...
//	DEFINE_FIELD( CBaseMonster, m_afSoundTypes, FIELD_INTEGER ),
	...
	DEFINE_FIELD( CBaseMonster, m_NextCamCheckTime, FIELD_TIME ),
...
{			 //   NONE	 MACH	 PLYR	 HPASS	 HMIL	 AMIL	 APASS	 AMONST	APREY	 APRED	 INSECT	PLRALY	PBWPN	ABWPN	CHARL	HELI	PLANT	
/*NONE*/		{ R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO,	R_NO,	R_NO,	R_NO,	R_NO,	R_NO	},
/*MACHINE*/		{ R_NO	,R_NO	,R_DL	,R_DL	,R_NO	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO,	R_DL,	R_DL,	R_NO,	R_NO,	R_NO	},
/*PLAYER*/		{ R_NO	,R_DL	,R_NO	,R_AL	,R_DL	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO,	R_DL,	R_DL,	R_DL,	R_DL,	R_NO	},
/*HUMANPASSIVE*/{ R_NO	,R_NO	,R_AL	,R_AL	,R_DL	,R_FR	,R_NO	,R_HT	,R_DL	,R_FR	,R_NO	,R_NO,	R_NO,	R_NO,	R_DL,	R_FR,	R_NO	},
/*HUMANMILITAR*/{ R_NO	,R_NO	,R_HT	,R_DL	,R_AL	,R_HT	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_HT,	R_NO,	R_NO,	R_DL,	R_NO,	R_NO	},
/*ALIENMILITAR*/{ R_NO	,R_DL	,R_HT	,R_DL	,R_HT	,R_AL	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL,	R_NO,	R_NO,	R_DL,	R_DL,	R_NO	},
/*ALIENPASSIVE*/{ R_FR	,R_FR	,R_FR	,R_FR	,R_FR	,R_FR	,R_NO	,R_FR	,R_FR	,R_FR	,R_NO	,R_FR,	R_NO,	R_NO,	R_FR,	R_NO,	R_NO	},
/*ALIENMONSTER*/{ R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL,	R_NO,	R_NO,	R_DL,	R_FR,	R_NO	},
/*ALIENPREY   */{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_FR	,R_NO	,R_DL,	R_NO,	R_NO,	R_DL,	R_FR,	R_NO	},
/*ALIENPREDATO*/{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_DL	,R_NO	,R_HT	,R_NM	,R_NO	,R_DL,	R_NO,	R_NO,	R_DL,	R_FR,	R_NO	},
/*INSECT*/		{ R_FR	,R_FR	,R_FR	,R_FR	,R_FR	,R_FR	,R_NO	,R_FR	,R_FR	,R_FR	,R_NO	,R_FR,	R_NO,	R_NO,	R_FR,	R_NO,	R_NO	},
/*PLAYERALLY*/	{ R_NO	,R_NO	,R_AL	,R_NO	,R_DL	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_AL,	R_NO,	R_NO,	R_HT,	R_FR,	R_NO	},
/*PBIOWEAPON*/	{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_DL,	R_NO,	R_DL,	R_DL,	R_NO,	R_NO	},
/*ABIOWEAPON*/	{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_AL	,R_NO	,R_DL	,R_DL	,R_NO	,R_NO	,R_DL,	R_DL,	R_NO,	R_DL,	R_NO,	R_NO	},
/*CHARLIE*/     { R_NO	,R_NO	,R_DL	,R_NO	,R_HT	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_HT,	R_NO,	R_NO,	R_AL,	R_FR,	R_NO	},
/*HELICOPTER*/  { R_NO	,R_NO	,R_HT	,R_NO	,R_NO	,R_HT	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_HT,	R_NO,	R_NO,	R_DL,	R_NO,	R_NO	},
/*PLANT*/		{ R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO,	R_NO,	R_NO,	R_NO,	R_NO,	R_NO	},
};
...
int CBaseMonster::IRelationshipSound ( CSound *pSound )
{
	return iEnemy[ Classify() ][ pSound->Classify() ];
}


//=========================================================
// Evacuate - will try and find a node that is within a 
// specified distance from vecThreat
//=========================================================

BOOL CBaseMonster :: Evacuate ( Vector vecThreat, Vector vecViewOffset, float flMinDist, float flMaxDist )
{
	int i;
	int iMyHullIndex;
	int iMyNode;
	...
	{
#if _DEBUG
		ALERT ( at_console, "Evacuate MinDist (%.0f) too close to MaxDist (%.0f)\n", flMinDist, flMaxDist );
#endif
	...
	{
		ALERT ( at_aiconsole, "Graph not ready for evacuate!\n" );
		return FALSE;
	}
	...
	for ( i = 0 ; i < WorldGraph.m_cNodes ; i++ )
	{
		...
		// make sure the node is within the mins/maxs of the search.
...
void CBaseMonster :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case SCRIPT_EVENT_SOUND:			// Play a named wave file
		EMIT_SOUND( edict(), CHAN_BODY, pEvent->options, 1.0, ATTN_NORM );
		break;

	case SCRIPT_EVENT_SOUND_VOICE:
		EMIT_SOUND( edict(), CHAN_VOICE, pEvent->options, 1.0, ATTN_NORM );
		break;
	...
	case SCRIPT_EVENT_SENTENCE:			// Play a named sentence group
		SENTENCEG_PlayRndSz( edict(), pEvent->options, 1.0, ATTN_NORM, 0, 100 );
		break;
...
void CBaseMonster :: MonsterInitDead( void )
{
	...
	CSoundEnt::InsertSound ( bits_SOUND_CARCASS, Classify(), pev->origin, 384, 100000 );
}
