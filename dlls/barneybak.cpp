...
TYPEDESCRIPTION	CBarney::m_SaveData[] = 
{
	...
	DEFINE_FIELD( CBarney, m_cClipSize, FIELD_FLOAT ),
};
...
void CBarney :: BarneyFirePistol ( void )
{
	...
	if ( pitchShift > 10 )
		...
		pitchShift -= 5;
	EMIT_SOUND_DYN( ENT(pev), CHAN_WEAPON, "weapons/colt_fire1.wav", 1, ATTN_NORM, 0, 100 + pitchShift );
...
void CBarney::Killed( entvars_t *pevAttacker, int iGib )
{
	...
	{// drop the gun!
		...
		CBaseEntity *pGun = DropItem( "weapon_colt1911a1", vecGunPos, vecGunAngles );
	}
