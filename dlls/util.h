...
#define		BLOOD_COLOR_BLUE	(BYTE)100
...
extern void			UTIL_SetFog( Vector col, int iFadeTime, int iStartDist, int iEndDist );
extern void			UTIL_Fog( BOOL fFogOn );
extern BOOL			UTIL_PlayMP3( const char *szFileName, BOOL looped, float flStartTime );
extern BOOL			UTIL_SearchHoEConfig( char * szParm, int ndefault );
extern void			UTIL_WriteHoEConfig();
