...
// houndeye does 20 points of damage spread over a sphere 512 units in diameter, and each additional 
// squad member increases the BASE damage by 120%, per the spec.
#define HOUNDEYE_MAX_SQUAD_SIZE			4
#define	HOUNDEYE_MAX_ATTACK_RADIUS		512
#define	HOUNDEYE_SQUAD_BONUS			(float)1.2
...
void CHoundeye :: SonicAttack ( void )
{
	...
	ExplosionCreate( pev->origin, pev->angles, edict(), 100, FALSE );
}
...
void CHoundeye :: GibMonster ( void )
{
	SonicAttack(); 
