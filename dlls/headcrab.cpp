...
{
	"spx_baby/attack1.wav",
	"spx_baby/attack2.wav",
	"spx_baby/attack3.wav",
};
...
void CHeadCrab :: Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/spx_baby.mdl");
...
void CHeadCrab :: Precache()
{
	...
	PRECACHE_MODEL("models/spx_baby.mdl");
}	
