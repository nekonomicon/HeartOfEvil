//
// Implementation of the CHumanFollowerMedic class
//
//=========================================================
...
void CHumanFollowerMedic :: Spawn( void )
{
	CHumanFollower::Spawn();
}


void CHumanFollowerMedic :: Precache( void )
{
...
void CHumanFollowerMedic :: Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	CHumanFollower::Use( pActivator, pCaller, useType, value );
}
...
void CHumanFollowerMedic :: SetActivity ( Activity NewActivity )
{
...
void CHumanFollowerMedic :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	switch( pEvent->event )
	{
...
void CHumanFollowerMedic::Heal( void )
{
...
void CHumanFollowerMedic :: StartTask( Task_t *pTask )
{
...
Schedule_t *CHumanFollowerMedic :: GetSchedule ( void )
{
...
void CHumanFollowerMedic::Killed( entvars_t *pevAttacker, int iGib )
{
	if ( m_nHeadNum == GetNumHeads() ) SetBodygroup( GetSyringeGroupNum(), HUMAN_FOLLOWER_MEDIC_SYRINGE_NONE );

	CHumanFollower::Killed( pevAttacker, iGib );
}
...
DEFINE_CUSTOM_SCHEDULES( CHumanFollowerMedic )
{
	slHumanFollowerMedicHeal,
	slHumanFollowerMedicChase,
};

IMPLEMENT_CUSTOM_SCHEDULES( CHumanFollowerMedic, CHumanFollower );
...
Schedule_t* CHumanFollowerMedic :: GetScheduleOfType ( int Type )
{
	switch( Type )
	{
