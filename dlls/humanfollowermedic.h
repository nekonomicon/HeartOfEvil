...
class CHumanFollowerMedic : public CHumanFollower
{
public:
	virtual void Spawn( );
	...
	BOOL SafeToChangeSchedule() { if ( m_Activity == ACT_SPECIAL_ATTACK1 ) return FALSE; return CHumanFollower::SafeToChangeSchedule(); };
