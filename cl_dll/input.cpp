...
kbutton_t	in_talk_come_here;
kbutton_t	in_talk_attack;
kbutton_t	in_talk_retreat;
kbutton_t	in_talk_get_down;
kbutton_t	in_talk_surpressing_fire;
kbutton_t	in_talk_outta_my_way;
kbutton_t	in_talk_behind_you;
...
void IN_Talk_ComeHere_Down (void) 
{
	if (!(in_talk_come_here.state & 1)) ClientCmd( "talk_come_here\n" ); 
	KeyDown(&in_talk_come_here);
}

void IN_Talk_ComeHere_Up (void) {KeyUp(&in_talk_come_here);}


void IN_Talk_Attack_Down (void) 
{
	if (!(in_talk_attack.state & 1)) ClientCmd( "talk_attack\n" ); 
	KeyDown(&in_talk_attack);
}

void IN_Talk_Attack_Up (void) {KeyUp(&in_talk_attack);}


void IN_Talk_Retreat_Down (void) 
{
	if (!(in_talk_retreat.state & 1)) ClientCmd( "talk_retreat\n" ); 
	KeyDown(&in_talk_retreat);
}

void IN_Talk_Retreat_Up (void) {KeyUp(&in_talk_retreat);}


void IN_Talk_GetDown_Down (void) 
{
	if (!(in_talk_get_down.state & 1)) ClientCmd( "talk_get_down\n" ); 
	KeyDown(&in_talk_get_down);
}

void IN_Talk_GetDown_Up (void) {KeyUp(&in_talk_get_down);}


void IN_Talk_SurpressingFire_Down (void) 
{
	if (!(in_talk_surpressing_fire.state & 1)) ClientCmd( "talk_surpressing_fire\n" ); 
	KeyDown(&in_talk_surpressing_fire);
}

void IN_Talk_SurpressingFire_Up (void) {KeyUp(&in_talk_surpressing_fire);}


void IN_Talk_OuttaMyWay_Down (void) 
{
	if (!(in_talk_outta_my_way.state & 1)) ClientCmd( "talk_outta_my_way\n" ); 
	KeyDown(&in_talk_outta_my_way);
}

void IN_Talk_OuttaMyWay_Up (void) {KeyUp(&in_talk_outta_my_way);}


void IN_Talk_BehindYou_Down (void) 
{
	if (!(in_talk_behind_you.state & 1)) ClientCmd( "talk_behind_you\n" ); 
	KeyDown(&in_talk_behind_you);
}

void IN_Talk_BehindYou_Up (void) {KeyUp(&in_talk_behind_you);}
...
void InitInput (void)
{
	...
	gEngfuncs.pfnAddCommand ("+talk_come_here", IN_Talk_ComeHere_Down);
	gEngfuncs.pfnAddCommand ("-talk_come_here", IN_Talk_ComeHere_Up);
	gEngfuncs.pfnAddCommand ("+talk_attack", IN_Talk_Attack_Down);
	gEngfuncs.pfnAddCommand ("-talk_attack", IN_Talk_Attack_Up);
	gEngfuncs.pfnAddCommand ("+talk_retreat", IN_Talk_Retreat_Down);
	gEngfuncs.pfnAddCommand ("-talk_retreat", IN_Talk_Retreat_Up);
	gEngfuncs.pfnAddCommand ("+talk_get_down", IN_Talk_GetDown_Down);
	gEngfuncs.pfnAddCommand ("-talk_get_down", IN_Talk_GetDown_Up);
	gEngfuncs.pfnAddCommand ("+talk_surpressing_fire", IN_Talk_SurpressingFire_Down);
	gEngfuncs.pfnAddCommand ("-talk_surpressing_fire", IN_Talk_SurpressingFire_Up);
	gEngfuncs.pfnAddCommand ("+talk_outta_my_way", IN_Talk_OuttaMyWay_Down);
	gEngfuncs.pfnAddCommand ("-talk_outta_my_way", IN_Talk_OuttaMyWay_Up);
	gEngfuncs.pfnAddCommand ("+talk_behind_you", IN_Talk_BehindYou_Down);
	gEngfuncs.pfnAddCommand ("-talk_behind_you", IN_Talk_BehindYou_Up);
