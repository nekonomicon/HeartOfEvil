...
int CBaseMonster::IRelationshipSound ( CSound *pSound ) { return 0; }
Activity CBaseMonster::GetSmallFlinchActivity( void ) { return ACT_SMALL_FLINCH; }
BOOL CBaseMonster::ShouldGibMonster( int iGib ) { return FALSE; }
void CBaseMonster::SetTurnActivity ( void ) { }
BOOL CBaseMonster::Evacuate(class Vector,class Vector,float,float) { return FALSE; }
