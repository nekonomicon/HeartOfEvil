...
#define CTEXTURESMAX		640			// max number of textures loaded
...
void PM_PlayStepSound( int step, float fvol )
{
	...
	case STEP_MUD:
		...
		{
		// right foot
		case 0:	pmove->PM_PlaySound( CHAN_BODY, "player/pl_mud1.wav", fvol, ATTN_NORM, 0, PITCH_NORM );	break;
		case 1:	pmove->PM_PlaySound( CHAN_BODY, "player/pl_mud3.wav", fvol, ATTN_NORM, 0, PITCH_NORM );	break;
		// left foot
		case 2:	pmove->PM_PlaySound( CHAN_BODY, "player/pl_mud2.wav", fvol, ATTN_NORM, 0, PITCH_NORM );	break;
		case 3:	pmove->PM_PlaySound( CHAN_BODY, "player/pl_mud4.wav", fvol, ATTN_NORM, 0, PITCH_NORM );	break;
		}
		break;
	}
}	
